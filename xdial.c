    ...
    int be;
{
    ...
    diresult[2].str =
        (trumpf == 5?
         ...
         (mes1?&textarr[TX_UEBERREIZT]:
          ...
          OB_NONE));
    diresult[3].str = &tsg; /* Gewonnen/Verloren */
    diresult[4].str = &tsa; /* Augen */
    diresult[5].str = &tsw; /* Spielwert */
    ...
    for (ln = 0; ln<NUM_LANG; ln++) {
        ...
        sprintf(sa[ln], textarr[TX_MIT_AUGEN].t[ln], stsum);
        strcat(sg[ln], sa[ln]);
        if (trumpf == -1) {
