...
EXTERN OBJECT digrafik[3][11]
#ifdef XDIAL_C
=
{{
  {11,0,0,40,11,OB_NONE,OB_NONE},
...
EXTERN OBJECT divarianten[3][37]
#ifdef XDIAL_C
=
{{
  {37,0,0,42,16,OB_NONE,OB_NONE},
  ...
  {OB_NONE,1,12,18,1,TOB(TX_ALTE_REGELN),OB_NONE},
  {OB_BUTTON,17,12,7,1,TOB(TX_NEIN),1},
  {OB_BUTTON,24,12,7,1,TOB(TX_JA),-1},
...
=
{
  {7,0,0,38,12,OB_NONE,OB_NONE},
  {OB_CENTERED|OB_UNDERLINED,1,1,36,1,TOB(TX_IRC_T),OB_NONE},
  {OB_CENTERED,1,3,36,1,TOB(TX_IRC_VERBINDUNG_HERSTELLEN),OB_NONE},
  {OB_EXIT,2,5,34,1,OB_NONE,OB_NONE},
  {OB_CENTERED,1,7,36,1,TOB(TX_IRC_KONFIGURATION_SIEHE),OB_NONE},
  {OB_CENTERED,1,8,36,1,TOB(TX_IRC_MAN_XSKAT),OB_NONE},
  {OB_EXIT,12,10,14,1,TOB(TX_WEITER),OB_NONE}
}
#endif
;

EXTERN OBJECT dieingabe[3][15]
#ifdef XDIAL_C
=
{{
  {15,0,0,38,12,OB_NONE,OB_NONE},
  {OB_CENTERED|OB_UNDERLINED,1,1,36,1,TOB(TX_EINGABE),OB_NONE},
  {OB_CENTERED,1,3,36,1,TOB(TX_MENU_BUTTON),OB_NONE},
  ...
  {OB_CENTERED,1,5,36,1,TOB(TX_UND_ESC_F1),OB_NONE},
  {OB_CENTERED,1,7,36,1,TOB(TX_TASTATUR),OB_NONE},
  {OB_BUTTON,3,8,10,1,TOB(TX_NEIN),1},
  {OB_BUTTON,14,8,10,1,TOB(TX_JA),1},
  {OB_BUTTON,25,8,10,1,TOB(TX_IMMER),-2},
  {OB_EXIT,12,10,14,1,TOB(TX_WEITER),OB_NONE}
}}
#endif
;
