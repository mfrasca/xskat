...
=
{
  ...
  {OB_EXIT,5,5,6,1,TOB(TX_JA),OB_NONE},
  {OB_EXIT,13,5,6,1,TOB(TX_NEIN),OB_NONE}
}
#endif
;
...
=
{
  ...
  {OB_EXIT,2,6,9,1,TOB(TX_LINKS),OB_NONE},
  {OB_EXIT,14,6,9,1,TOB(TX_MIR),OB_NONE},
  {OB_EXIT,26,6,9,1,TOB(TX_RECHTS),OB_NONE},
...
=
{
  ...
  {OB_CENTERED,1,5,35,1,OB_NONE,OB_NONE},
  {OB_CENTERED,1,7,35,1,TOB(TX_DER_SPIELWERT_IST),OB_NONE},
...
EXTERN OBJECT dismlres[3][15]
#ifdef XDIAL_C
=
{{
  {15,0,0,33,8,OB_NONE,OB_NONE},
  ...
  {OB_CENTERED|OB_BOLD,1,7,31,1,OB_NONE,OB_NONE}
}}
#endif
;
...
EXTERN OBJECT diliste[3][62]
#ifdef XDIAL_C
=
{{
  {62,0,0,38,21,OB_NONE,OB_NONE},
...
EXTERN OBJECT dioptions[3][22]
#ifdef XDIAL_C
=
{{
  {22,0,0,38,21,OB_NONE,OB_NONE},
...
{{
  ...
  {OB_CENTERED,1,4,38,1,TOB(TX_EMAIL),OB_NONE},
  {OB_CENTERED,1,6,38,1,TOB(TX_HOMEPAGE),OB_NONE},
  {OB_CENTERED,1,7,38,1,TOB(TX_URL),OB_NONE},
  {OB_CENTERED,1,9,38,1,TOB(TX_FR1),OB_NONE},
  {OB_CENTERED,1,10,38,1,TOB(TX_FR2),OB_NONE},
  {OB_CENTERED,1,11,38,1,TOB(TX_FR3),OB_NONE},
  {OB_CENTERED,1,12,38,1,TOB(TX_FR4),OB_NONE},
  {OB_EXIT,13,14,14,1,TOB(TX_WEITER),OB_NONE}
}}
#endif
;

EXTERN OBJECT distrateg[3][29]
#ifdef XDIAL_C
=
{{
  {29,0,0,40,11,OB_NONE,OB_NONE},
  {OB_CENTERED|OB_UNDERLINED,1,1,38,1,TOB(TX_COMPUTER_T),OB_NONE},
  {OB_NONE,1,3,10,1,TOB(TX_STRATEGIE),OB_NONE},
  {OB_NONE,12,3,10,1,TOB(TX_PASSE_K),OB_NONE},
  {OB_RIGHT,29,3,10,1,TOB(TX_SAGE18),OB_NONE},
  {OB_NONE,2,4,9,1,TOB(TX_LINKS),OB_NONE},
  {OB_BUTTON,12,4,3,1,OB_NONE,1},
  {OB_BUTTON,15,4,3,1,OB_NONE,1},
  {OB_BUTTON,18,4,3,1,OB_NONE,1},
  {OB_BUTTON,21,4,3,1,OB_NONE,1},
  {OB_BUTTON,24,4,3,1,OB_NONE,1},
  {OB_BUTTON,27,4,3,1,OB_NONE,1},
  {OB_BUTTON,30,4,3,1,OB_NONE,1},
  {OB_BUTTON,33,4,3,1,OB_NONE,1},
  {OB_BUTTON,36,4,3,1,OB_NONE,-8},
  {OB_NONE,2,5,9,1,TOB(TX_RECHTS),OB_NONE},
  {OB_BUTTON,12,5,3,1,OB_NONE,1},
  {OB_BUTTON,15,5,3,1,OB_NONE,1},
  {OB_BUTTON,18,5,3,1,OB_NONE,1},
  {OB_BUTTON,21,5,3,1,OB_NONE,1},
  {OB_BUTTON,24,5,3,1,OB_NONE,1},
  {OB_BUTTON,27,5,3,1,OB_NONE,1},
  {OB_BUTTON,30,5,3,1,OB_NONE,1},
  {OB_BUTTON,33,5,3,1,OB_NONE,1},
  {OB_BUTTON,36,5,3,1,OB_NONE,-8},
  {OB_NONE,1,7,10,1,TOB(TX_VORSCHLAEGE),OB_NONE},
  {OB_BUTTON,12,7,8,1,TOB(TX_NEIN),1},
  {OB_BUTTON,20,7,8,1,TOB(TX_JA),-1},
  {OB_EXIT,13,9,14,1,TOB(TX_WEITER),OB_NONE}
}}
#endif
;

EXTERN OBJECT divarianten[3][34]
#ifdef XDIAL_C
=
{{
  {34,0,0,42,15,OB_NONE,OB_NONE},
  ...
  {OB_NONE,1,4,20,1,TOB(TX_SCHIEBERAMSCH),OB_NONE},
  {OB_BUTTON,17,4,7,1,TOB(TX_NEIN),1},
  {OB_BUTTON,24,4,7,1,TOB(TX_JA),-1},
  {OB_NONE,1,5,20,1,TOB(TX_KONTRA_SAGEN),OB_NONE},
  {OB_BUTTON,17,5,7,1,TOB(TX_NEIN),1},
  {OB_BUTTON,24,5,7,1,TOB(TX_JA),1},
  {OB_BUTTON,31,5,10,1,TOB(TX_AB18),-2},
  {OB_NONE,1,6,20,1,TOB(TX_BOCK_RUNDEN),OB_NONE},
  {OB_BUTTON,17,6,7,1,TOB(TX_NEIN),1},
  {OB_BUTTON,24,6,7,1,TOB(TX_JA),1},
  {OB_BUTTON,31,6,10,1,TOB(TX_UND_RAMSCH),-2},
  {OB_NONE,3,7,18,1,TOB(TX_FORTSETZEN),OB_NONE},
  {OB_BUTTON,17,7,7,1,TOB(TX_NEIN),1},
  {OB_BUTTON,24,7,7,1,TOB(TX_JA),-1},
  {OB_NONE,1,8,18,1,TOB(TX_SPITZE),OB_NONE},
  {OB_BUTTON,17,8,7,1,TOB(TX_NEIN),1},
  {OB_BUTTON,24,8,7,1,TOB(TX_JA),1},
  {OB_BUTTON,31,8,10,1,TOB(TX_PLUS2),-2},
  {OB_NONE,1,9,18,1,TOB(TX_REVOLUTION),OB_NONE},
  {OB_BUTTON,17,9,7,1,TOB(TX_NEIN),1},
  {OB_BUTTON,24,9,7,1,TOB(TX_JA),-1},
  {OB_NONE,1,10,18,1,TOB(TX_KLOPFEN),OB_NONE},
  {OB_BUTTON,17,10,7,1,TOB(TX_NEIN),1},
  {OB_BUTTON,24,10,7,1,TOB(TX_JA),-1},
  {OB_NONE,1,11,18,1,TOB(TX_SCHENKEN),OB_NONE},
  {OB_BUTTON,17,11,7,1,TOB(TX_NEIN),1},
  {OB_BUTTON,24,11,7,1,TOB(TX_JA),-1},
  {OB_EXIT,14,13,14,1,TOB(TX_WEITER),OB_NONE}
}}
#endif
;

EXTERN OBJECT dibockevents[3][11]
#ifdef XDIAL_C
=
{{
  {11,0,0,42,14,OB_NONE,OB_NONE},
...
EXTERN OBJECT diverzoegerung[3][14]
#ifdef XDIAL_C
=
{{
  {14,0,0,27,12,OB_NONE,OB_NONE},
  {OB_CENTERED|OB_UNDERLINED,1,1,25,1,TOB(TX_VERZOEGERUNG),OB_NONE},
  {OB_CENTERED,1,3,25,1,TOB(TX_NIMM_STICH_NACH),OB_NONE},
  {OB_CENTERED,1,4,25,1,OB_NONE,OB_NONE},
  {OB_EXIT,2,5,3,1,OB_NONE,OB_NONE},
  {OB_EXIT,6,5,3,1,OB_NONE,OB_NONE},
  {OB_EXIT,10,5,3,1,OB_NONE,OB_NONE},
  {OB_EXIT,14,5,3,1,OB_NONE,OB_NONE},
  {OB_EXIT,18,5,3,1,OB_NONE,OB_NONE},
  {OB_EXIT,22,5,3,1,OB_NONE,OB_NONE},
  {OB_CENTERED,1,7,25,1,TOB(TX_GEBEN),OB_NONE},
  {OB_BUTTON,2,8,11,1,TOB(TX_SCHNELL),1},
  {OB_BUTTON,14,8,11,1,TOB(TX_LANGSAM),-1},
  {OB_EXIT,7,10,13,1,TOB(TX_WEITER),OB_NONE}
}}
#endif
;

EXTERN OBJECT dimenubutton[3][9]
#ifdef XDIAL_C
=
{{
  {9,0,0,38,7,OB_NONE,OB_NONE},
  {OB_CENTERED|OB_UNDERLINED,1,1,36,1,TOB(TX_MENU_BUTTON),OB_NONE},
  {OB_BUTTON,3,3,7,1,TOB(TX_JEDER),1},
  {OB_BUTTON,11,3,4,1,OB_NONE,1},
  {OB_BUTTON,16,3,4,1,OB_NONE,1},
  {OB_BUTTON,21,3,4,1,OB_NONE,1},
  {OB_BUTTON,26,3,4,1,OB_NONE,1},
  {OB_BUTTON,31,3,4,1,OB_NONE,-5},
  {OB_EXIT,12,5,14,1,TOB(TX_WEITER),OB_NONE}
}}
#endif
;
